...
<body>
    ...
    <section class="creacion-actos">
        <h2 style="text-align: center">Eventos Pasados</h2>
        <?php
            $meses = ['Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre'];
            ...
            foreach ($actos as $fecha => $eventosdia) {
                ...
                if (isset($eventosdia) && count($eventosdia) > 0){
                    ...
                    foreach($eventosdia as $evento){
                            ...
                            echo "<div class='evento $suscrito'>
                                <a href='/panelponente/documentos/acto?id=$idevento' style='color: black; text-decoration: none;'>
