...
<div class="panel-admin">
    ...
    <section class="creacion-actos">
        ...
        @endphp
            ...
            <form action='/paneladmin/acto/eliminar?id={{$acto['Id_acto']}}' method='POST'>
                @csrf
                <button class='form-submit-button-delete' type='submit'>Borrar Acto</button>
            </form>
            <!--Ini Agregar ponente apalac-->
                <a role="button" href="/paneladmin/ponente/crear?id={{$acto['Id_acto']}}" class='form-submit-button-ponente'>Agregar ponente</a>
                <a role="button" href="/paneladmin/ponente/borrar?id={{$acto['Id_acto']}}" class='form-submit-button-ponente'>Borrar ponente</a>
